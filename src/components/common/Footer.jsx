    ...
    <section className='py-10 bg-[#f4faff]'>
        ...
        <div className='md:flex md:gap-[12rem] md:w-[80%] w-[90%] mx-auto py-6'>
          <div className='flex justify-between md:w-[66%]'>
            <div className='mx-6 md:mx-0 '>
              ...
              <a href=''><p className='text-sm mb-4'>About us</p></a>
              <a href=''><p className='text-sm mb-4'>Contact us</p></a>
              <a href=''><p className='text-sm mb-4'>Help</p></a>
            </div>
            <div className='mx-6 md:mx-0'>
              <h3 className='pb-4 text-lightgray'>SERVICES</h3>
              <a href=''><p className='text-sm mb-4'>Transfer money</p></a>
              <a href=''><p className='text-sm mb-4'>Send money</p></a>
              <a href=''><p className='text-sm mb-4'>Receive money</p></a>
              <a href=''><p className='text-sm mb-4'>Online Shopping</p></a>
      ...
      <div className='md:flex justify-between md:w-[80%] mx-auto pt-10 text-lightgray'>
        <div className='text-center'>
          Copyright © 2024&nbsp; <a href='/' className='text-icon'>SwiftPayu.</a> All Rights Reserved.
        </div>

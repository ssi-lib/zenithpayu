...
const items = [
  {
    ...
    title: 'Easy to use',
    description:
      "SwiftPayu's online platform is user-friendly and easy to navigate, providing customers with a hassle-free banking experience. With a simple and intuitive interface, customers can access their accounts, make payments, and transfer funds with ease.",
  },
  {
    icon: FaShare,
    ...
    <section className="py-20 md:px-8 px-2">
      <div className="text-center mb-5">
        ...
        <p className="font-light text-[1.25rem]">
          Here’s Top 4 reasons why using a SwiftPayu account for manage your
          money.
        </p>
      </div>

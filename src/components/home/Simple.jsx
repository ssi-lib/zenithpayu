    ...
    <section className='py-24 px-6 bg-feature'>
      ...
      <div className='grid md:grid-cols-3 gap-16 w-[90%] mx-auto'>
          <div className='text-center'>
            ...
            <h4 className='font-medium mb-3 text-lg'>Sign Up your account</h4>
          ...
          <div className='text-center'>
            ...
            <h4 className='font-medium mb-3 text-lg'>Send & Receive Money</h4>
          ...
          <div className='text-center'>
            ...
            <h4 className='font-medium mb-3 text-lg'>Withdraw Funds</h4>

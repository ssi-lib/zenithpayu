        ...
        >
          ...
          <div className="relative md:top-1/3 md:mt-0 mt-28 z-10">
            <div className="text-center md:w-[75%] w-[95%] mx-auto">
              <h1 className="md:text-[2.75rem] text-[2rem] mb-8 font-medium">
                About ZenithPayu
              </h1>
              <p className="text-xl">
                Our core mission is to provide you with a cost-effective and
                efficient financial solution by offering competitive exchange
                rates and reducing transfer fees. Our team is dedicated to
                empowering you with the tools and resources necessary to achieve
                your financial goals. We believe in creating a seamless and
                secure platform for our clients to send and receive money, while
                prioritizing transparency and integrity in all our transactions.
              </p>
            </div>
      ...
      <section className="bg-[#0581ce] py-10">
        <div className="grid md:grid-cols-4 w-[85%] mx-auto">
          <div className="text-white text-center mb-8 md:mb-0">
            ...
            <h1 className="font-medium md:text-5xl text-3xl md:my-4 my-2">
              180+
            </h1>
            <h3>Countries</h3>
          </div>

...
import { FaMoneyCheckAlt, FaShieldAlt, FaCreditCard, FaRegEnvelope, FaRegCommentAlt, FaChevronRight } from "react-icons/fa";
  ...
  return(
    <main className="bg-[#f5f5f5]">
        ...
        <div className="absolute inset-0" style={{ backgroundImage: `url(${customerSupport})`, backgroundPosition: "10%", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
          ...
          <div className="relative top-1/2 z-10 py-5">
            <div className='text-center'>
              <h1 className='md:text-[2.75rem] text-[1.75rem] font-medium'>How can we help you?</h1>
            </div>
          </div>
        </div>
      </section>
      <section className="grid md:grid-cols-4 gap-8 w-[90%] mx-auto my-12">
        <div className='text-center bg-white py-6 rounded-md shadow-sm'>
          <div className='p-6'>
      ...
      <section className="grid md:grid-cols-2 gap-8 w-[90%] mx-auto my-12 md:my-28">
        <div className='bg-white py-6 rounded-md shadow-sm md:flex items-center'>
          <div className='p-6'>
